...
export const reviewItems: ReviewItem[] = [
  ...
  },
  {
    ...
    questionIds: [47],
    resolution:
      'REOPENED AND REVERSED 2026-08-18. A prior pass concluded the app\'s \'3 years from violation OR 2 years from discovery\' matched neither model act and rewrote the chapter, cheat sheet and question 47 around a 1956 rule of \'two years after the contract of sale\', citing 410(e). Checked against the primary text - NASAA\'s 1956 Uniform Securities Act with NASAA Updates and Commentary - that is wrong on three counts. The limitations clause is 410(f), not 410(e); 410(e) is the survival-of-action provision. 410(f) reads: no person may sue more than three years after the contract of sale, or the rendering of investment advice, or the expiration of two years after the discovery of the facts constituting the violation, whichever first occurs. So the original 3/2 pairing WAS the statutory text, and the phrase \'four years\' appears nowhere in the act. All three surfaces are restored to 410(f) and the question 47 explanation no longer calls the 1956 formulation a teaching convention. Retained improvement: the rendering-of-investment-advice trigger, which the original omitted and which matters for adviser claims.',
  },
  {
    id: 'iar-ce-adoption',
