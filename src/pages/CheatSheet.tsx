...
const thresholds: ThresholdRow[] = [
  ...
  { rule: 'Qualified client AUM', threshold: '$1.4M with the IA (raised from $1.1M on 6/29/2026)' },
  ...
  { rule: 'Civil statute of limitations', threshold: '1956 act: earlier of 3 yrs after sale/advice or 2 yrs after discovery · 2002 act: earlier of 2 yrs after discovery / 5 yrs after violation' },
...
const topRules: RuleRow[] = [
  ...
  { rule: 'BD agent: discretionary trades without a written DPOA are unauthorized — even if profitable AND suitable. IA: may start on ORAL authority, written required within 10 business days of the first transaction (NASAA Model Rule 102(a)(4)-1).' },
  { rule: 'Time/price discretion does NOT need written authorization for either a BD agent or an IA. Full discretion does.' },
